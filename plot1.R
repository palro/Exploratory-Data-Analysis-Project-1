...
##Step5 : Plot1 : Clear any plots on current graphics device , create plot, copy to png file , close device
graphics.off()
hist(Feb_twodays$Global_active_power,xlab="Global Active Power (kilowatts)", ylab = "Frequency", col = "red", main = "Global Active Power")
